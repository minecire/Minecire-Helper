...
{
    [CustomEntity("MinecireHelper/WideCustomSummitCheckpoint = GenerateCustomSummitCheckpoint")]
    public class WideCustomSummitCheckpoint : SummitCheckpoint
    {
        ...
        public static Entity GenerateCustomSummitCheckpoint(Level level, LevelData levelData, Vector2 offset, EntityData entityData)
        {
            ...
            return new WideCustomSummitCheckpoint(entityData, offset);
        }

        private readonly Color[] confettiColors;
        private readonly string groupFlag;

        public WideCustomSummitCheckpoint(EntityData data, Vector2 offset) : base(data, offset)
        {
            ...
            string directory = data.Attr("spriteDirectory", defaultValue: "MinecireHelper/summitcheckpoints_wide");
        ...
        private void triggerGroupFlag(Action<WideCustomSummitCheckpoint> actionOnEntireGroup)
        {
            ...
            foreach (WideCustomSummitCheckpoint other in Scene.Tracker.GetEntities<WideCustomSummitCheckpoint>())
            {
