...
{
    [CustomEntity("MinecireHelper/CustomSummitCheckpoint = GenerateCustomSummitCheckpoint")]
    public class CustomSummitCheckpoint : SummitCheckpoint
    {
        ...
        public CustomSummitCheckpoint(EntityData data, Vector2 offset) : base(data, offset)
        {
            ...
            string directory = data.Attr("spriteDirectory", defaultValue: "MinecireHelper/summitcheckpoints");
