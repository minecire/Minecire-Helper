...
namespace Celeste.Mod.MinecireHelper.Triggers
{
    [CustomEntity("MinecireHelper/BronzeBerryCollectTrigger")]
    [Tracked]
    class BronzeBerryCollectTrigger : Trigger
    {
        ...
        public BronzeBerryCollectTrigger(EntityData data, Vector2 offset) : base(data, offset) { }
        ...
        private static void hookStrawberryUpdate(ILContext il)
        {
                ...
                instr => instr.OpCode == OpCodes.Callvirt && (instr.Operand as MethodReference)?.FullName == "System.Boolean Monocle.Entity::CollideCheck<Celeste.GoldBerryCollectTrigger>()"))
            {
                ...
                Logger.Log("MinecireHelper/BronzeBerryCollectTrigger", $"Modding gold berry collect at {cursor.Index} in IL for Strawberry.orig_Update");
                ...
                cursor.EmitDelegate<Func<Player, bool, Strawberry, bool>>((player, orig, self) => {
                    ...
                    return orig || ((self is BronzeBerry) && player.CollideCheck<BronzeBerryCollectTrigger>());
                });
            }
        }
    }
